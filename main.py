from tkinter import Tk, Frame, Listbox, Entry, Button, Text, END, Label, messagebox
...
class CategoryWindow:
    def __init__(self, master):
        ...
        self.select_button = Button(self.master, text="Select", command=self.select_category)
        self.select_button.pack()

        self.delete_button = Button(self.master, text="Delete", command=self.delete_category)
        self.delete_button.pack()

        self.rename_button = Button(self.master, text="Rename", command=self.rename_category)
    ...
    def delete_category(self):
        ...
        if selected_index:
            ...
            response = messagebox.askyesno("Delete Category", f"Are you sure you want to delete the category '{selected_category}'?")
    ...
    def rename_category(self):
        ...
        if selected_index:
            selected_category = self.category_listbox.get(selected_index)
            new_category = messagebox.askstring("Rename Category", f"Enter a new name for the category '{selected_category}':")
            if new_category:
...
class ContentWindow:
    def __init__(self, master):
        ...
        self.save_button = Button(self.master, text="Save", command=self.save_content)
        self.save_button.pack()

        self.copy_button = Button(self.master, text="Copy", command=self.copy_content)
